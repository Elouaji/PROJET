...
-->
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#forms"
                            ...
                            <span class="nav-text">Gestion des utilisateurs</span> <b class="caret"></b>
                          </a>
                          <ul  class="collapse"  id="forms">
                            <div class="sub-menu">
                              
                              <li >
                                <a href="basic-input.html">ajouter utilisateur</a>
                              </li>
                              
                              <li >
                                <a href="input-group.html">liste des utilisateurs</a>
                              </li>
                             <!-- 
                              <li >
...
-->
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#pages"
                      ...
                      <i class="mdi mdi-image-filter-none"></i>
                      <span class="nav-text">gestion des catégories</span> <b class="caret"></b>
                    </a>
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="user-profile.html">
                                <span class="nav-text">ajouter catégorie</span>
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#authentication"
                            ...
                            <span class="nav-text">liste des catégories</span> <b class="caret"></b>
                          </a>
        ...
        <!--                
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#documentation"
                      ...
                      <i class="mdi mdi-image-filter-none"></i>
                      <span class="nav-text">Gestion des produits</span> <b class="caret"></b>
                    </a>
